...
public class EnderecoClienteController {
    ...
    public List<EnderecoCliente> mostrarTodosEnderecosCliente() {
        List<EnderecoCliente> endereco = enderecoClienteService.mostrarTodosEnderecosCliente();
        return endereco;
    }

    @GetMapping("/enderecoCliente/{idEnderecoCli}")
    public ResponseEntity<EnderecoCliente> mostrarEnderecoPeloid(@PathVariable Integer idEnderecoCli) {
